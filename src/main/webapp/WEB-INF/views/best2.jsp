        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let i = 0; i < 100; i++) {
                    ...
                    $('.bookTitle' + i).append("<h4>저자</h4>" + "<p>" + data.response.docs[i].doc.authors + "</p>")
                    $('.bookTitle' + i).append("<h4>장르</h4>" + "<p>" + data.response.docs[i].doc.class_nm + "</p>")
                    $('.bookTitle' + i).append("<h4>출판사</h4>" + "<p>" + data.response.docs[i].doc.publisher + "</p>")
